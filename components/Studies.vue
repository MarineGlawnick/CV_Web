<template>
    <section id="studies">
        <h1 class="text-center mb-4">Mon parcours</h1>
        <div id="accordionFlushExample" class="accordion accordion-flush">
            <div class="accordion-item">
                <h2 class="accordion-header">
                    ...
                    >
                        Formation Développeuse Web - 2022-23
                    </button>
                </h2>
                <div
            ...
            <div class="accordion-item">
                <h2 class="accordion-header">
                    ...
                    >
                        Master Mention Métiers de l'Enseignement, de l'Education et de la Formation Option Anglais -
                        2019-21
                    </button>
                </h2>
                <div
                ...
                >
                    <div class="accordion-body lh-lg">
                        ...
                        établissements scolaires de ma ville
                    </div>
                </div>
            </div>
            <div class="accordion-item">
                ...
                >
                    <div class="accordion-body lh-lg">
                        ...
                        Dans mon cas, j'ai eu l'occasion d'approffondir mes connaissances dans la langue anglaise et
                        découvrir la culture Irlandaise pendant 1 an
                    </div>
                </div>
            </div>
            <div class="accordion-item">
                <h2 class="accordion-header">
                    ...
                    >
                        Licence Langues, Littératures et Civilisations Etrangères en anglais - 2014-17
                    </button>
                </h2>
                <div
